...
During progression, each player in the raid and on the bench is also awarded an amount of “hazard pay” EP equal to the EP value of the first boss in the raid, once per full hour of raiding as raid leaders see fit. Once the final boss of that raid has been killed at least once, no further hazard pay is awarded for that raid.

If the raid leadership asks a raider to switch which character they raid on, all EP and GP will transfer over between the two characters. We had originally planned to have characters accrue EP/GP separately when we were planning on having two raid teams, but now that we have a single raid team we will have EP/GP accrue on a per-raider basis instead, provided it’s been cleared with the raid leadership first.
...
There are three levels of bids that can be placed on items: major upgrade, minor upgrade, and greed. Major upgrade bids cost 100% of the item’s base GP, and take priority over all other types of bids. Minor upgrade bids cost 50% of the item’s base GP, and take priority over off-spec bids. Greed bids cost 10% of the item’s base GP, and are the lowest priority bid.

#### Flex

Flex is a special priority level for people who are asked by raid leaders to respec. To make a flex bid, you must be in your non-standard spec (for instance, prot when you usually raid as arms). If an item drops that would be an upgrade your flex set, any greed bid you make will gain priority over other greed bids, and if you win the item you will be awarded it for free.
...
We have two levels of item priority: bolded and non-bolded. Bolded priority has priority over non-bolded priority, which has priority over general bids. When an item drops, every member whose class/spec matches the bolded priority may make a major or minor bid. If none do, every member whose class/spec matches the non-bolded priority may make a major or minor bid. If none do, every member of the raid may make a major, minor, or greed bid.

Legendary items are all handled by loot council, and any BOE recipes and mats are considered guild property.
...
If an item with a prio drops and receives no major upgrade bids, it goes down one level of priority. For instance, if an item with a bolded priority of rogues and a non-bolded priority of warriors receives no major upgrade bids, rogues lose their bolded prio (so it can be bid on equally by rogues and warriors). If it drops again and still receives no major upgrade bids, it would lose all prios.

#### Bidder’s Remorse

We’re all getting used to EP/GP, so for the duration of phase 1 we’ll be offering free backsies if you win an item then realize it’s not actually good for you. Although the backsies will be refunded in GP, you may still face the embarrassment of the raid - so be conscious of the items that you need for major/minor/greed before the raid! Starting in phase 2 we’ll continue to offer backsies, but at a GP cost equal to a greed bid (10%).
